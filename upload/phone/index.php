...
<label class="btn btn-danger">
  ...
  <input  type="button" class="btn btn-primary btn-lg" value="Upload File" onclick="uploadFile()">

  <h3 id="status"></h3>
  <p id="loaded_n_total"></p>
<progress id="progressBar"  value="0" max="100" class="progress" style="width:75%"></progress>
<br><br>
<html >
<head>
